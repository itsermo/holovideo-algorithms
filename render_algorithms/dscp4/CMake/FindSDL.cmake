...
if(SDL_LIBRARY_TEMP)
  ...
  if(WIN32)
	find_library(SDL_LIBRARY_DEBUG NAMES NAMES sdl sdl2)
	find_library(SDLMAIN_LIBRARY_DEBUG NAMES sdl2main sdl2maind)
  endif()
endif()
...
LIST (INSERT SDL_LIBRARY 0 optimized)
LIST (APPEND SDL_LIBRARY debug ${SDL_LIBRARY_DEBUG})
endif()

if(SDLMAIN_LIBRARY_DEBUG)
LIST (INSERT SDLMAIN_LIBRARY 0 optimized)
LIST (APPEND SDLMAIN_LIBRARY debug ${SDLMAIN_LIBRARY_DEBUG})
endif()
